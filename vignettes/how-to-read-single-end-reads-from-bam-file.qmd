...
discussed further here. See `?scanBam` in the `Rsamtools` package for more 
information. Single-end reads can be read with the `readGAlignments` 
...
See `?filterBam` in the `Rsamtools` package for more information.
